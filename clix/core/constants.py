...
# REST API endpoints
REST_FRIENDSHIPS_CREATE = f"{API_BASE}/1.1/friendships/create.json"
REST_FRIENDSHIPS_DESTROY = f"{API_BASE}/1.1/friendships/destroy.json"
REST_BLOCKS_CREATE = f"{API_BASE}/1.1/blocks/create.json"
REST_BLOCKS_DESTROY = f"{API_BASE}/1.1/blocks/destroy.json"
REST_MUTES_CREATE = f"{API_BASE}/1.1/mutes/users/create.json"
REST_MUTES_DESTROY = f"{API_BASE}/1.1/mutes/users/destroy.json"
REST_GUIDE = f"{API_BASE}/2/guide.json"

# Display truncation limits
COMPACT_TWEET_TEXT_LIMIT = 140
COMPACT_USER_BIO_LIMIT = 120
TWEET_DISPLAY_LIMIT = 280
THREAD_QUOTE_LIMIT = 120
THREAD_PREVIEW_LIMIT = 200
TABLE_MAX_WIDTH = 50
TABLE_MAX_WIDTH_WIDE = 60
SCHEDULED_TEXT_PREVIEW_LIMIT = 47
DM_PREVIEW_LIMIT = 60

# MCP retry guidance (seconds)
MCP_RETRY_RATE_LIMIT = 60
MCP_RETRY_STALE_ENDPOINT = 5
